...
document.getElementById("submitPlayers").onclick = () => {
    ...
    if (continueGame) {
        ...
        const obliviate = new DarkArtsEvent("Obiviate", "Game 2", () => {players.forEach(player => {playerChoice(`${player.hero} loses:`, () => {return 2;}, 1, () => {document.getElementsByClassName("choice")[0].innerHTML = "Spell<br/>" + hogwartsCardBack; document.getElementsByClassName("choice")[0].onclick = () => {const spells = player.hand.filter(card => {return card.type === "spell";}); playerChoice(`${player.hero} discards:`, () => {return spells.length;}, 1, () => {for (let i = 0; i < spells.length; i++) {document.getElementsByClassName("choice")[i].innerHTML = `<img src="${spells[i].img.src}">`; document.getElementsByClassName("choice")[i].onclick = () => {player.forcedDiscardAt(player.hand.indexOf(spells[i]));};}});}; document.getElementsByClassName("choice")[1].innerHTML = healthToken + healthToken; document.getElementsByClassName("choice")[1].onclick = () => {player.health -= 2;};});});});
        const poison = new DarkArtsEvent("Poison", "Game 2", () => {players.forEach(player => {playerChoice(`${player.hero} loses:`, () => {return 2;}, 1, () => {document.getElementsByClassName("choice")[0].innerHTML = "Ally<br/>" + hogwartsCardBack; document.getElementsByClassName("choice")[0].onclick = () => {const allies = player.hand.filter(card => {return card.type === "ally";}); playerChoice(`${player.hero} discards:`, () => {return allies.length;}, 1, () => {for (let i = 0; i < allies.length; i++) {document.getElementsByClassName("choice")[i].innerHTML = `<img src="${allies[i].img.src}">`; document.getElementsByClassName("choice")[i].onclick = () => {player.forcedDiscardAt(player.hand.indexOf(allies[i]));};}});}; document.getElementsByClassName("choice")[1].innerHTML = healthToken + healthToken; document.getElementsByClassName("choice")[1].onclick = () => {player.health -= 2;};});});});
        const relashio = new DarkArtsEvent("Relashio", "Game 2", () => {players.forEach(player => {playerChoice(`${player.hero} loses:`, () => {return 2;}, 1, () => {document.getElementsByClassName("choice")[0].innerHTML = "Item<br/>" + hogwartsCardBack; document.getElementsByClassName("choice")[0].onclick = () => {const items = player.hand.filter(card => {return card.type === "item";}); playerChoice(`${player.hero} discards:`, () => {return items.length;}, 1, () => {for (let i = 0; i < items.length; i++) {document.getElementsByClassName("choice")[i].innerHTML = `<img src="${items[i].img.src}">`; document.getElementsByClassName("choice")[i].onclick = () => {player.forcedDiscardAt(player.hand.indexOf(items[i]));};}});}; document.getElementsByClassName("choice")[1].innerHTML = healthToken + healthToken; document.getElementsByClassName("choice")[1].onclick = () => {player.health -= 2;};});});});
