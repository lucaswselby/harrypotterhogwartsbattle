    ...
    if (continueGame) {
        ...
        class Player {
            constructor(hero, proficiency) {
                ...
                this._discard = []; 
                this._passives = [];
                if (hero === "Harry Potter") this._discard = harryStartingCards.concat(bezoar1);
